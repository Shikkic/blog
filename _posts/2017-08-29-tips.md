...
There are many ways to be effective when using a computer for work or hobby. Infact, there are so many nuaiced ways that can vary from program to program, it would be difficult to layout an effective methodology to approach them all.
...
I have one core philosphy that I follow and hope to instill in you. However keep in mind people have different opinions and this is just my own.

### The Philosphy

It's simple.

> Keep your hands off the mouse as my as possible. *Especially* if you're not on a laptop.
...
One of the biggest usages of manually resizing windows and dragging them around is to make two windows equal size, side-by-side, or some variance of that. Now imagine wanting switch the applications you have set side-by-side, it's an even bigger waste of time.

We're going to learn how to stream line that process so it's lighting fast.
